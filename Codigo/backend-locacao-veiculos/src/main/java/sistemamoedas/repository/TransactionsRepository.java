...
public interface TransactionsRepository extends JpaRepository <Transactions,Long> {
    ...
    Page<Transactions> findAllByIdOriginAccountOrIdDestinationAccountAndDeletedAtIsNullOrderByIdTransaction(Pageable page, User idOriginAccount, User idDestinationAccount);
